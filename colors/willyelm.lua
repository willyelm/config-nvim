...
hi("StatusLine", { fg = s.light_gray, bg = transparent, sp = divider })
...
hi("PmenuDoc", { bg = transparent })
hi("PmenuThumb", { bg = bg_very_subtle })
hi("PmenuBorder", { fg = divider, bg = transparent })
hi("PmenuDocBorder", { fg = divider, bg = transparent })
