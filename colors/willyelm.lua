...
hi("Keyword", { fg = color.fg_primary, bold = true })
...
hi("FoldColumn", { fg = color.fg_faint, bg = color.bg_main })
hi("CursorLineFold", { fg = color.fg_faint, bg = color.bg_active })
...
hi("WordHighlight", { bg = color.bg_active })
hi("Folded", { fg = color.fg_muted, bg = color.bg_action })
hi("UfoFoldedEllipsis", { fg = color.fg_muted, italic = true })
...
hi("BlinkCmpMenuBorder", { fg = color.divider, bg = color.bg_main })
hi("BlinkCmpDocBorder", { fg = color.divider, bg = color.bg_main })
hi("BlinkCmpLabelMatch", { fg = color.fg_info, bold = true })
hi("BlinkCmpKindFunction", { fg = color.fg_accent })
hi("BlinkCmpKindMethod", { fg = color.fg_accent })
hi("BlinkCmpKindVariable", { fg = color.fg_link })
hi("BlinkCmpKindKeyword", { fg = color.fg_primary })
hi("BlinkCmpKindType", { fg = color.fg_warning })
